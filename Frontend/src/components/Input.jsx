        ...
        <div className="mb-4">
            ...
            <div className="relative">
                {isSelect ? (
                    ...
                    <input
                    className="w-full bg-transparent outlint-none border-gray-300 rounded-md py-2 px-3 pr-10 text-gray-700 leading-tight focus:oultine-none focus:border-blue-500"
